...
reply_match_rules = Table(
    ...
    Column("id", String(64), primary_key=True),
    Column("tenant_id", String(64), ForeignKey("tenants.id", ondelete="CASCADE"), nullable=False),
    Column("campaign_id", String(64), ForeignKey("campaigns.id", ondelete="CASCADE")),
    Column("reply_template_id", String(64), ForeignKey("reply_templates.id", ondelete="SET NULL")),
    Column("name", String(255), nullable=False),
    Column("enabled", Boolean, nullable=False, default=True),
    Column("priority", Integer, nullable=False, default=100),
...
reply_plans = Table(
    ...
    Column("tenant_id", String(64), ForeignKey("tenants.id", ondelete="CASCADE"), nullable=False),
    Column("campaign_id", String(64), ForeignKey("campaigns.id", ondelete="CASCADE"), nullable=False),
    Column("execution_id", String(64), ForeignKey("executions.id", ondelete="CASCADE")),
    Column("platform_account_id", String(64), ForeignKey("platform_accounts.id", ondelete="RESTRICT"), nullable=False),
    ...
    Column("created_by", String(64), ForeignKey("users.id", ondelete="SET NULL")),
    Column("approved_by", String(64), ForeignKey("users.id", ondelete="SET NULL")),
...
reply_candidates = Table(
    ...
    Column("campaign_id", String(64), ForeignKey("campaigns.id", ondelete="CASCADE"), nullable=False),
    Column("execution_id", String(64), ForeignKey("executions.id", ondelete="CASCADE")),
    Column("reply_plan_id", String(64), ForeignKey("reply_plans.id", ondelete="CASCADE")),
    Column("platform_account_id", String(64), ForeignKey("platform_accounts.id", ondelete="RESTRICT"), nullable=False),
    Column("platform", String(50), nullable=False, default="facebook"),
    ...
    Column("approved_by", String(64), ForeignKey("users.id", ondelete="SET NULL")),
    Column("approved_at", DateTime(timezone=True)),
    Column("rejected_by", String(64), ForeignKey("users.id", ondelete="SET NULL")),
...
reply_records = Table(
    ...
    Column("id", String(64), primary_key=True),
    Column("tenant_id", String(64), ForeignKey("tenants.id", ondelete="CASCADE"), nullable=False),
    Column("reply_candidate_id", String(64), ForeignKey("reply_candidates.id", ondelete="SET NULL")),
    Column("reply_plan_id", String(64), ForeignKey("reply_plans.id", ondelete="SET NULL")),
    Column("campaign_id", String(64), ForeignKey("campaigns.id", ondelete="CASCADE"), nullable=False),
    Column("platform_account_id", String(64), ForeignKey("platform_accounts.id", ondelete="RESTRICT"), nullable=False),
    Column("comment_id", String(255)),
